...
To install schematics_flexible, run this command in your terminal:

.. code-block:: console

    $ pip install schematics_flexible

This is the preferred method to install schematics_flexible, as it will always install the most recent stable release. 
